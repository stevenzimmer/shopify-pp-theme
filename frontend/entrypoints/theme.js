...
//   mobileNavTrigger.querySelector('.hamburger').classList.toggle('pp-hidden');
//   mobileNavTrigger.querySelector('.close').classList.toggle('pp-hidden');
//   navMain.classList.toggle('pp-hidden');
// });
